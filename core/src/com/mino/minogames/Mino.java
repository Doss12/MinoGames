...
public class Mino {
	...
	public void pose_triomino(Mino plateau, int id_cote)
	{
		if(id_cote == 0)
		{
			//if(this.get_orientation() == orientation.VERTICALE)
			//{
				while(!(this.cote[0] == plateau.cote[1] && this.cote[1] == plateau.cote[0]))
					pivoter_triomino();
			/*}
			else
			{
				while(!(this.cote[0] == plateau.cote[2] && this.cote[2] == plateau.cote[0]))
					pivoter_triomino();
			}*/
		}
		else if(id_cote == 1)
		{
			while(!(this.cote[1] == plateau.cote[2] && this.cote[2] == plateau.cote[1]))
				pivoter_triomino();
		}
		else if(id_cote == 2)
		{
			//if(this.get_orientation() == orientation.VERTICALE)
			//{
				while(!(this.cote[2] == plateau.cote[0] && this.cote[0] == plateau.cote[2]))
					pivoter_triomino();
			/*}
			else
			{
	...
	public void pivoter_triomino()
	{
		System.out.println("ON PIVOTE !!!");
		int tmp1 = cote[1];
		int tmp2 = cote[2];
		cote[1] = cote[0];
